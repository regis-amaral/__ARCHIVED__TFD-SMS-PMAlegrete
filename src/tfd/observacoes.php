...
if($_GET[excluir] == true){$obs = NULL; $grav = $_GET[exidint]; $_POST[idint] = $_GET[exidint];}
		...
		$updateSQL = "UPDATE internacao SET observacao='$obs' WHERE idint='$grav'";
...
<form name="form1" method="post" action="observacoes.php">
  <table width="580" border="0" cellpadding="0" cellspacing="0">
    <!--DWLayoutTable-->
    <tr> 
      <td width="15" height="25">&nbsp;</td>
      <td width="23">&nbsp;</td>
      <td width="176" valign="top"><strong>Observa&ccedil;&atilde;o:</strong></td>
      <td width="213">&nbsp;</td>
      <td width="16">&nbsp;</td>
      <td width="57">&nbsp;</td>
      <td width="32">&nbsp;</td>
    ...
    <tr> 
      <td height="165">&nbsp;</td>
      <td>&nbsp;</td>
      <td colspan="2" rowspan="4" valign="top"><textarea name="observacao" cols="58" rows="12" id="observacao"><?php echo $row_recInternacao['observacao']; ?></textarea></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr> 
      ...
      <td></td>
      <td></td>
      <td colspan="2" valign="top"><a href="observacoes.php?excluir=excluir&exidint=<?php echo $row_recInternacao['idint']; ?>&exid=<?php echo $row_recInternacao['idpac'];?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','img/excluir2.gif',1)"><img src="img/excluir.gif" name="image2" width="55" height="14" border="0" id="image2"></a> 
    ...
    <tr>
      <td height="22"></td>
      <td colspan="7" valign="top"><?php echo $mensagem;?></td>
      </tr>
  </table>
</form>
</body>
